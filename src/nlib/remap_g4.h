...
// narray_init_memory() has already copied the code image to physical SRAM1;
...
// narray_init_memory() in a RAM-model Reset_Handler; ROM builds simply
// don't. G4-only by unit convention — no other family has this remap.

#include "device.h"

static inline void narray_remap0(void) {
